...
def main():
    ...
    for ref_image_path in config["test_cases"].keys():
        ...
        for pose_video_path in config["test_cases"][ref_image_path]:
            ...
            for pose_image_pil in pose_images[: min(len(pose_images), args.L)]:
            ...
            ref_image_tensor = repeat(
                ref_image_tensor, "b c f h w -> b c (repeat f) h w", repeat=min(len(pose_images), args.L)
            )
